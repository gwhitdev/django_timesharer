...
urlpatterns = [
    ...
    path('volunteer/<int:volunteer_id>/amend-live-status', views.amend_vol_live_status, name='amend_vol_status'),
    ...
    path('organisation/<int:organisation_id>/amend-live-status', views.amend_org_live_status, name='amend_org_status'),
    ...
    path('opportunity/<int:opportunity_id>/amend-live-status', views.amend_opp_live_status, name='amend_opp_status'),
]